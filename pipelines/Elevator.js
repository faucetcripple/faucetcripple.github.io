...
// shade elevator lite with hue::
	gl_FragColor = pixel * vec4(col, 1.0);

// shade elevator lite equation::
//	gl_FragColor = pixel / (vec4(col, 1.0)*4.);

// shade elevator equation::
//	gl_FragColor = pixel - (vec4(col, 1.0)*4.);
}
`;

export default class ELEVATOR extends Phaser.Renderer.WebGL.Pipelines.PostFXPipeline {
    constructor(game) {
        super({
            game,
            renderTarget: true,
